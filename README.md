...
#### 3.1 Model
We estimate a VAR(6) model identified through sign restrictions where $e_t = B \epsilon_t$. The matrix $B$ is identified such that $\Omega = BB'$.

#### 3.2 Data Sources (FRED)
* **Real GDP**: Output gap derived from GDPC1.
* **CPI**: Inflation rate derived from CPIAUCSL.
* **Federal Funds Rate**: Monetary policy instrument (FEDFUNDS).
